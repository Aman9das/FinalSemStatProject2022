...
Sanitation of oneself is one of the basic duties of a human being. We know poor sanitation is linked to transmission of diarhoeal diseases such as cholera and dysentery, as well as typhoid, intestinal worm infections and polio which directly affect the health of an individual. Moreover, we also know that the Gross Domestic Product per capita of a country basically tells about the wealth of a country. So, in this project Our *Aim* is to determine how these features affect the *Health* of the citizens. We use *Life Expectation* as a measurable proxy for health.
