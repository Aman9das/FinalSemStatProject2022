...
We observe and understand the general distribution of the three features in the Univariate Analysis.

Let us try to visualize their Bivariate relationship in the Scatter Plot.
...
Our aim is to deduce which features more directly affect the Life Expectancy. Thus we should remove the effect of the other features using Partial Correlation.
...
<summary>How the years' life expectancies an year's GDP correlate with.</summary>
...
<summary>How the years' life expectancies an year's Sanitation correlate with.</summary>
